...
// ============================================================
// TRANSFA & BANK PRIVACY POPUP (slides from top)
// ============================================================
class TransfaBankPrivacyPopup extends StatefulWidget {
  final VoidCallback? onClose;
  final VoidCallback? onAgree;

  const TransfaBankPrivacyPopup({
    super.key,
    this.onClose,
    this.onAgree,
  });
  ...
  @override
  State<TransfaBankPrivacyPopup> createState() => _TransfaBankPrivacyPopupState();
}

class _TransfaBankPrivacyPopupState extends State<TransfaBankPrivacyPopup>
