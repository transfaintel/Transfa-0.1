...
// ============================================================
// TRANSFA STATUS POPUP (slides from top)
// ============================================================
class TransfaStatusPopup extends StatefulWidget {
  ...
  @override
  State<TransfaStatusPopup> createState() => _TransfaStatusPopupState();
}

class _TransfaStatusPopupState extends State<TransfaStatusPopup>
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  'The money has been received by “${widget.bankName}” and the receiver’s account is expected to be credited within 5 minutes. Transfa AI is coming.',
                                  style: const TextStyle(
                                    fontFamily: 'Roboto',
                                    fontWeight: FontWeight.w400,
                                    fontSize: 16,
